...
int main(int argc, char** argv, char** env) {
	...
	for(int i = 0; i < 100000; i ++){
		if(dut.finish != 1){
			...
			sprintf(buf,"%d / %d = [%d]--[%d]---[%d]--[%d]",a2, b2, dut.result,a2/b2,dut.rem,a2%b2);
			sscanf(buf,"%d / %d = [%d]--[%d]---[%d]--[%d]",&a1, &b1, &s1,&m1, &r1,&m2);
			// printf("%s",buf);
	...
	uint32_t a2_u = 0, b2_u = 0;
	uint32_t a1_u = 0, b1_u = 0;
	uint32_t r1_u = 0, s1_u = 0;
	uint32_t m1_u = 0, m2_u = 0;
